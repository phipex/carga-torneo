...
import UserClientUpdateComponent from '@/entities/user-client/user-client-update.vue';
import UserClientClass from '@/entities/user-client/user-client-update.component';
...
describe('Component Tests', () => {
  describe('UserClient Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<UserClientClass>(UserClientUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        userClientServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(userClientServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.userClient = entity;
        userClientServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(userClientServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        userClientServiceStub.retrieve.resolves([foundUserClient]);
